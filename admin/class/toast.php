...
$toast_xml = '<?xml version="1.0" encoding="utf-8" ?><wp:Notification xmlns:wp="WPNotification"><wp:Toast><wp:Text1>'.信息：.'</wp:Text1><wp:Text2>'.$message.'</wp:Text2></wp:Toast></wp:Notification>';

...
$sql_array[] = 'CREATE TABLE IF NOT EXISTS `songtable` (`id` int(11) NOT NULL AUTO_INCREMENT,`sid` int(11) NOT NULL,songtitle text NOT NULL,songcover text NOT NULL,songurl text NOT NULL,PRIMARY KEY (`id`))';
